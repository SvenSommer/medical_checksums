...
class TestLANRCheck(unittest.TestCase):
    def test_calculate_checksum(self):
        self.assertEqual(calculate_checksum("123456"), 6)
        self.assertEqual(calculate_checksum("987654"), 4)
        self.assertEqual(calculate_checksum("545878"), 2)
        self.assertEqual(calculate_checksum("444444"), 4) #4 Pseudoarztnummer im Rahmen des Reha-Entlassmanagements noch verwendet
        self.assertEqual(calculate_checksum("999999"), 9) #9 Hochschulambulanzen nach § 117 SGB V sowie psychiatrische und psychosomatische Institutsambulanzen nach § 118 SGB V und einige weitere Ambulanztypen
        self.assertEqual(calculate_checksum("999999"), 9) #9 Pseudoarztnummer im Rahmen des Reha-Entlassmanagements noch verwendet
    ...
    def test_validate_lanr(self):
       # self.assertTrue(validate_lanr("545878998"))
        ...
        self.assertTrue(validate_lanr("333333300"))
